...
cd ../quickbill-ui
npm install
Configure your local environment parameters by ensuring your target API base URL aligns with Uvicorn (usually http://127.0.0.1:8000). Then, run the development server:
